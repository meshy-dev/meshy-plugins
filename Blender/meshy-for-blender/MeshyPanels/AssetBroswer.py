...
class MeshyApi:
    ...
    def download_thumbnail(self, model):
        ...
        thumbnail_dir = bpy.utils.user_resource(
...
class MeshyLoadThumbnailsOperator(Operator):
    ...
    def download_thumbnail(self, model):
        ...
        preview_collection["meshy"][model.name] = bpy.utils.previews.new().load(
            model.name, model.thumbnail_path, "IMAGE"
        )
        ...
        if model.thumbnail_path:
            items.append(
                (
                    ...
                    model_name,
                    "",
                    preview_collection["meshy"][model_name].icon_id,
                    i,
                )
            )
        else:
